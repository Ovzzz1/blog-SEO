...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .item-tag.technique {{ border-color: rgba(96, 165, 250, 0.3); color: #93c5fd; background: rgba(96, 165, 250, 0.1); }}
...
<header>
  <div class="wrap">
    ...
    <a href="glossaire/index.html" style="display: inline-block; margin-top: 1rem; font-family: var(--mono); font-size: 11px; color: var(--accent); text-transform: uppercase; letter-spacing: 0.1em; text-decoration: none; border: 1px solid var(--accent); padding: 0.4rem 1rem; border-radius: 2px; transition: all 0.15s;" onmouseover="this.style.background='var(--accent)'; this.style.color='var(--paper)'" onmouseout="this.style.background='transparent'; this.style.color='var(--accent)'">Voir le glossaire technique →</a>
  </div>
</header>
